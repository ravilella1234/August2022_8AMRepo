...
public class CustomerRegistrationPage extends BaseTest
{
	...
	{
		signIn.click();		
		//custEmail.sendKeys("qatest4574349@gmail.com");
		String str = "qatest"+randomNum()+"@gmail.com";
		...
		waitForElement(driver, 60,Title_gen1,"elementToClickable");
